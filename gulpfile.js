...
var project      = 'bootstrap-system', // Project name, used for build zip.
    url          = 'http://localhost:8080/bootstrap-system', // Local Development URL for BrowserSync. Change as-needed.
    bower        = './assets/bower_components/'; // Not truly using this yet, more or less playing right now. TO-DO Place in Dev branch
    build        = './bootstrap-system/', // Files that you want to package into a zip go here
    customJs = [];
...
// Copy everything under `src/assets/fonts` indiscriminately
